...
Uma radio necessita realizar alguns cálculos estatísticos referente
ao número de minutos de musicas e de propagandas que são vinculadas.
Considere que a radio fica 744 horas por mês no ar.
Solicite POR SEMANA o número horas da programação em que foram vinculadas músicas
e o numero de horas em que foram vinculadas apenas propagandas. Calcule e mostre:
